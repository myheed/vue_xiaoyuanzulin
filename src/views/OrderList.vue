      ...
      <router-link :to="{name:'用户页'}">
        <a href="javascript:;" class="aui-navBar-item">
			...
			<div class="aui-center">
				<span class="aui-center-title">我的租赁</span>
			</div>
			<a href="javascript:;" class="aui-navBar-item">
        <router-link :to="{name:''}">
							...
							<block v-for="(menuList2,index3) in menuList" :key="index3">
								<div class="tab-item">
									...
									<a href="javascript:;" class="aui-mail-payment">
										<p>
											共{{menuList2.sum}}件商品 租金: ￥{{menuList2.pri}}
										</p>
									</a>
									<div class="aui-mail-button">
										...
										<a href="javascript:;" :class="[menuList2.but_jiesuzu==0 ? 'hd' : menuList2.but_jiesuzu==2 ? '' :'aui-df-color']">结束租赁</a>
										<!-- <a href="javascript:;" :class="[menuList2.but_rebuy==0 ? 'hd' : menuList2.but_rebuy==2 ? '' :'aui-df-color']">再次购买</a> -->
										<a href="javascript:;" :class="[menuList2.but_zaicizu==0 ? 'hd' : menuList2.but_zaicizu==2 ? '' :'aui-df-color']">再次租赁</a>
						<!-- 				<a href="javascript:;" :class="[menuList2.but_tuiyajin==0 ? 'hd' : menuList2.but_tuiyajin==2 ? '' :'aui-df-color']">退取租金</a> -->
